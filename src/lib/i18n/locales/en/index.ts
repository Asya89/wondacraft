export const en = {
  ...
  order: {
    ...
    submit: 'Send order',
    consent: 'I agree that my details may be used to process this order.',
    consentRequired: 'Consent is required',
    successTitle: 'Your order was sent successfully',
    successThanks: 'Thank you for choosing WondaCraft.',
    successMessage:
      'We will contact you to confirm the order and agree on the delivery details.',
    orderNumber: 'Order number',
    orderNumberHint: 'Please keep this number in case you need to contact us about the order later.',
    total: 'Total',
